...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxAsyn = __webpack_require__(185);

	var _reduxAsyn2 = _interopRequireDefault(_reduxAsyn);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store = (0, _redux.createStore)(_reducers2.default, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxAsyn2.default), window.devToolsExtension ? window.devToolsExtension() : function (f) {
	    return f;
	}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function App(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'span',
	            { style: { display: errorInfo ? 'inline' : 'none' } },
	            'message : ',
	            errorInfo,
	            ' '
	        ),
	        ' ',
	        _react2.default.createElement('br', null),
	        _react2.default.createElement('input', { type: 'text', placeholder: 'username is hello', ref: function ref(node) {
	                return userName = node;
	            } }),
	        ' ',
	        _react2.default.createElement('br', null),
	        _react2.default.createElement('input', { type: 'password', placeholder: 'password is 123456', ref: function ref(node) {
	                return pwd = node;
	            } }),
	        ' ',
	        _react2.default.createElement('br', null),
	        _react2.default.createElement(
	            ...
	            { onClick: function onClick() {
	                    return login(userName.value, pwd.value);
	                } },
	            ' Login '
	        )
	    );
	...
	exports.default = (0, _reactRedux.connect)(function (state) {
	    ...
	    return {
	        login: function login(userName, pwd) {
	            return dispatch(_extends({}, _actions.LOGIN_ASYN, { userName: userName, pwd: pwd }));
	        }
	    };
	})(App);
...
/***/ function(module, exports) {
	...
	var LOGIN_SUCCESS = exports.LOGIN_SUCCESS = { type: 'LOGIN_SUCCESS' };
	var LOGIN_FAILED = exports.LOGIN_FAILED = { type: 'LOGIN_FAILED', info: null };
	var LOGIN_ASYN = exports.LOGIN_ASYN = {
	    type: 'LOGIN_ASYN',
	    asyn: function asyn(_ref) {
	        ...
	        setTimeout(function () {
	            if (userName == 'hello') {
	                if (pwd == '123456') dispatch(LOGIN_SUCCESS);else dispatch(_extends({}, LOGIN_FAILED, { info: 'your password is wrong.' }));
	            } else dispatch(_extends({}, LOGIN_FAILED, { info: 'user \'' + userName + '\' does not exists.' }));
	        }, 2000);
	    },
	    pwd: null,
	    userName: null
...
/***/ function(module, exports, __webpack_require__) {
	...
	var status = function status() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? 'hass not login' : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _actions.LOGIN_ASYN.type:
	            return 'login ...';
	        case _actions.LOGIN_SUCCESS.type:
	            return 'login success !';
	        case _actions.LOGIN_FAILED.type:
	            return 'login failed .';
	        default:
	            return state;
	    }
	...
	var error_info = function error_info() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? '' : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports) {
	...
	exports.default = asynMiddleware;
	...
	* */
	...
	function asynMiddleware() {
	    return function (next) {
	        return function (action) {
	            next(action);
	            var type = action.type;
	            var asyn = action.asyn;

	            var param = _objectWithoutProperties(action, ["type", "asyn"]);

	            if (asyn) asyn(_extends({ dispatch: next }, param));
	            return action;
	        };
	    };
	}
